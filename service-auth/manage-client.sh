#!/usr/bin/env bash
# Jalankan CLI interaktif "npm run manage-client" di dalam container service-auth yang
...
set -euo pipefail
cd "$(dirname "$0")" # folder service-auth/ — tempat docker-compose.yml-nya sendiri
